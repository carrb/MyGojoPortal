USE NewResourcePartnersDevelopment 
GO
...
--Create the assembly
CREATE ASSEMBLY [SqlRegEx] FROM 'C:\Program Files\Microsoft SQL Server\100\Tools\Binn\SqlRegEx\SqlRegEx.dll' WITH PERMISSION_SET = SAFE
GO
