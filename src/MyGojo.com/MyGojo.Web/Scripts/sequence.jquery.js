...
(function($){
	...
	var get = {
		...
		* Build: http://www.modernizr.com/download/#-prefixed-testprop-testallprops-domprefixes*/
		...
		defaultPreloader: function(prependTo, transitions, prefix){
			...
			$(prependTo).prepend('<div class="sequence-preloader"><div class="preloading"><img src="Content/Images/sequence-preloader.png" alt="Sequence is loading, please wait..." />    <img src="Content/Images/sequence-preloader.png" alt="Sequence is loading, please wait..." />    <img src="Content/Images/sequence-preloader.png" alt="Sequence is loading, please wait..." /></div></div>');
		}
	},
	...
	defaults = {
		...
		pauseButtonSrc: "Content/Images/bt-pause.png",
		pauseButtonAlt: "&#166;&#166;",
		...
		pauseIconSrc: "Content/Images/pause-icon.png",
		pauseAlt: "Pause",
